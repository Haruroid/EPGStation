<template>
    <v-content>
        ...
        <GuidePreviousDaySelectDialog :isOpen.sync="isOpenDaySelectDialog"></GuidePreviousDaySelectDialog>
    </v-content>
</template>

<script lang="ts">
import Channel from '@/components/guide/Channel.vue';
import GuidePreviousDaySelectDialog from '@/components/guide/GuidePreviousDaySelectDialog.vue';
...
export default class Guide_Previous extends Vue {
    ...
    public onUrlChange(): void {
        ...
        this.$nextTick(async () => {
            ...
            // 番組表データ取得
            try {
                await this.guideState.fetchGuide_Recorded(this.createFetchGuideOption());
            } catch (err) {
                this.isLoading = false;
            ...
            if (typeof this.$refs.programs !== 'undefined') {
                this.setDisplayRange();
                this.guideState.createPreviousProgramDoms(typeof this.$route.query.channelId !== 'undefined');
